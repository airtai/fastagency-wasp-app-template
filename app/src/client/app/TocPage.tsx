      ...
      <div className='mx-auto max-w-2xl pl-10 pr-10 text-white pt-10 pb-24 sm:pb-32 lg:gap-x-8 lg:py-5 lg:px-8'>
        <div className='container mx-auto py-8'>
          ...
          <section className='mb-8'>
            <p>
              These terms and conditions ("Terms") govern your access to and use of {appName}, a Software-as-a-Service
              tool ("Service"). By accessing or using the Service, you agree to be bound by these Terms. If you do not
              agree to these Terms, you may not access or use the Service.
            </p>
          </section>
          <section className='mb-8'>
            <h2 className='text-xl font-semibold mb-2'>Use Terms for {appName}</h2>
            <p>
